...
public class PopularGeo {

	public static ArrayList<String> MostActiveGeo() {
		...
		try {
			...
			statement.append("( ");
			statement.append("SELECT h.Id FROM PROFILE h WHERE h.CId = '").append(UserProfile.getCId()).append("'");
			statement.append(") ");
			statement.append("OR ");
