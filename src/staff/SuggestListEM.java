...
import rendezvous.SuggestDate;
import rendezvous.MainConnector;

public class SuggestListEM {
	...
	public static boolean AppendSuggestList(String rep, String Id1, String Id2) {
		boolean result = false;
		if (SuggestDate.AppendSuggestList(Id1, Id2)) {
			result = true;
			try {
				Connection con = MainConnector.getCon();
				StringBuilder statement = new StringBuilder();
				PreparedStatement ps;
				statement.append("CALL SuggestAProfile('");
				statement.append(rep).append("','").append(Id1).append("','").append(Id2).append("',@S);");
