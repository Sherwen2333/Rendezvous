...
<body>
	...
	<div class="infoContainer">
		...
		%>
		<form method="post" action="profileInfoEdit.jsp?pid=<%=info.getProfileId()%>&op=1">
			<div>
		...
		<div class="editBTN">
			<a href="profileInfo_Cus.jsp?pid=<%=info.getProfileId()%>&op=1">Edit&nbsp;<i class="fa fa-edit"></i></a>
		</div>
		<%
			}
		%>
		...
		%>
		<form method="post" action="profileInfoEdit.jsp?pid=<%=info.getProfileId()%>&op=2">
			<div>
		...
		<div class="editBTN">
			<a href="profileInfo_Cus.jsp?pid=<%=info.getProfileId()%>&op=2">Edit&nbsp;<i class="fa fa-edit"></i></a>
		</div>
		<%
			}
		%>
		...
		%>
		<form method="post" action="profileInfoEdit.jsp?pid=<%=info.getProfileId()%>&op=3">
			<div>
		...
		<div class="editBTN">
			<a href="profileInfo_Cus.jsp?pid=<%=info.getProfileId()%>&op=3">Edit&nbsp;<i class="fa fa-edit"></i></a>
		</div>
		<%
			}
		%>	
		...
		<%
			if(option == 4){ /* Edit Account Info */
				boolean isMale = info.getGender().equals("Male");
		%>
		<form method="post" action="profileInfoEdit.jsp?pid=<%=info.getProfileId()%>&op=4">
			<div>
		...
		<div class="editBTN">
			<a href="profileInfo_Cus.jsp?pid=<%=info.getProfileId()%>&op=4">Edit&nbsp;<i class="fa fa-edit"></i></a>
		</div>
		<%
			}
		%>
		...
		%>
				<div class="closeContainer">
					<a href="profileInfoEdit.jsp?pid=<%=info.getProfileId()%>&op=666">Delete This Profile</a>
				</div>
		<%
			}
		%>
