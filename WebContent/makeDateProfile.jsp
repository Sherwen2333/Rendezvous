...
<body>
	...
	<!-- Buttons -->
	<div class="signOut">
		<a href="makeDateWith.jsp">Back</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="signOut.jsp">Sign Out</a>
	</div>
	<div class="staffSSN">
	</div>
	<!--=============================================================================-->
	...
	<div class="formInnerContainer">
		<form method="post" action="makeDateProfileCheck.jsp">
			<div>
			...
			<div class="error">
				<%
					switch(DateProcessing.status){
					case 1: {
						out.print("Invalid Date or Time");
						break;
					}
					case 2: {
						out.print("For Geo Date, location and zipcode must be filled");
						break;
					}
					case 3: {
