...
<body>
	...
	<div class="md_text">
		Date between <em><%=RecordDateMA.Id1%></em> and <em><%=RecordDateMA.Id2%></em>
	</div>
	<!--=============================================================================-->
	<!--================================= Form ======================================-->
	<!--=============================================================================-->
	...
	<div class="formInnerContainer">
		<form method="post" action="recordDateMAInfoCheck.jsp">
			<!--============= pid =============-->
			<div>
			</div>
			<!--============= Date =============-->
			...
			<!--============= RepId =============-->
			<div>
				<b>RepId:&nbsp;&nbsp;</b><input type="text" name="repId" maxlength="24" style="width:10em;">
			</div>
			<!--============= Fee =============-->
			<div>
			...
			<div class="error">
				<%
					switch(RecordDateMAInfo.status){
					case 1: {
