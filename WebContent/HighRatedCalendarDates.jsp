...
<body>
	...
	<div class="optionContainer">
		<a href="" class="option option3">Highest-rated Calendar Dates to Have A Date On</a>
	</div>
	<!--=============================================================================-->
	<!--=============================================================================-->
	<!--=============================================================================-->
	<%
		ArrayList<String> list = CustomerAnalysis.HighRatedCalendarDates();
	%>
	<div style="width: 100%; text-align: center; margin-top: 2em;">
		<form method="get" action="HighRatedCalendarDates.jsp">
			<div class="formText">
	...
	<div class="MostActiveCustomer">
		<table style="width: 100%; text-align: center; margin: 1em 0em;">
			<tr>
				<th>Highest-rated Calendar Dates</th>
			</tr>
			<%
