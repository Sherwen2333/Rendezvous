	...
	<%
		try {
			...
			case 1: {
				...
				if (status) {
					response.sendRedirect("profileInfo_Cus.jsp?pid=" + newId + "&op=0");
				} else {
					response.sendRedirect("profileInfo_Cus.jsp?pid=" + id + "&op=11");
				}
				break;
			}
			case 2: {
				...
				if (status) {
					response.sendRedirect("profileInfo_Cus.jsp?pid=" + id + "&op=0");
				} else {
					response.sendRedirect("profileInfo_Cus.jsp?pid=" + id + "&op=21");
				}
				break;
			}
			case 3: {
				...
				if (status) {
					...
					response.sendRedirect("profileInfo_Cus.jsp?pid=" + id + "&op=31");
				}
				break;
			}
			case 4: {
				...
				if (status) {
					...
					response.sendRedirect("profileInfo_Cus.jsp?pid=" + id + "&op=41");
				}
				break;
			}
			case 666: {
