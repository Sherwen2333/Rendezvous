...
<body>
	...
	<!-- Buttons -->
	<div class="signOut">
		<a href="suggestListEM.jsp">Back</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="signOut.jsp">Sign Out</a>
	</div>
	<div class="staffSSN">
	</div>
	<!--=============================================================================-->
	...
	<%
		String Id1="";
		String Id2="";
		Id1=SuggestListEM.Id1;
		Id2=SuggestListEM.Id2;
		SuggestListEM.Id1="";
		SuggestListEM.Id2="";
 		if(SuggestListEM.AppendSuggestList(session.getAttribute("staffSSN")+"", Id1, Id2)){
			%>
