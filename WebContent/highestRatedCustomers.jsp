...
<body>
	...
	<div class="optionContainer">
		<a class="option option2" href="">Highest Rated Customers</a>
	</div>
	...
	<%
		...
		ArrayList<String> list = CustomerAnalysis.HighRatedCustomer(max);
	%>
	<div style="width: 100%; text-align: center; margin-top: 2em;">
		<form method="get" action=highestRatedCustomers.jsp>
			<div class="formText">
